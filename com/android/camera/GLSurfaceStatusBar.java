...
public class GLSurfaceStatusBar {
    private static final int PREVIEW_TOP_PADDING = CameraAppImpl.getAndroidContext().getResources().getDimensionPixelSize(C0049R.dimen.camera_control_top_height);
