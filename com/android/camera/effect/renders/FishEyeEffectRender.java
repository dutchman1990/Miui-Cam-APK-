...
public class FishEyeEffectRender extends ConvolutionEffectRender {
    ...
    public FishEyeEffectRender(GLCanvas gLCanvas, int i) {
        super(gLCanvas, i);
    }
    ...
    public void setPreviewSize(int i, int i2) {
        ...
        int i3 = i > i2 ? i2 : i;
        float sqrt = (float) Math.sqrt((double) ((this.mPreviewWidth * this.mPreviewWidth) + (this.mPreviewHeight * this.mPreviewHeight)));
        if (i3 > 1080) {
