...
public class InstagramRiseEffectRender extends RGBTransEffectRender {
    ...
    protected InstagramRiseEffectRender(GLCanvas gLCanvas, int i) {
        super(gLCanvas, i);
    }
    ...
    public static Render create(GLCanvas gLCanvas, int i) {
        ...
        Render instagramRiseEffectRender = new InstagramRiseEffectRender(gLCanvas, i);
        instagramRiseEffectRender.setRGBTransLutBuffer(getSelfRGBLutBuffer());
        return new PipeRenderPair(gLCanvas, curveEffectRender, instagramRiseEffectRender, false);
    }
