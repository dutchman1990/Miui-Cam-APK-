...
public abstract class RGBTransEffectRender extends PixelEffectRender {
    ...
    public RGBTransEffectRender(GLCanvas gLCanvas, int i) {
        super(gLCanvas, i);
    }
    ...
    public void setRGBTransLutBuffer(IntBuffer intBuffer) {
        ...
        GLES20.glTexImage2D(3553, 0, 6408, intBuffer.capacity(), 1, 0, 6408, 5121, intBuffer);
