...
public abstract class RegionEffectRender extends ConvolutionEffectRender {
    ...
    private void init() {
        ...
        this.mThresholdWidth = resources.getDimensionPixelSize(C0049R.dimen.effect_item_width);
        this.mThresholdHeight = resources.getDimensionPixelSize(C0049R.dimen.effect_item_height);
    }
