...
public class WarningCallback implements StereoWarningCallback {
    ...
    public void onWarning(int i) {
        Log.i(TAG, "onWarning type = " + i);
        switch (i) {
            case 0:
                Toast.makeText(this.mActivity, C0049R.string.dual_camera_lens_covered_toast, 0).show();
                this.mIsDualCameraReady = false;
                return;
            case 1:
                Toast.makeText(this.mActivity, C0049R.string.dual_camera_lowlight_toast, 0).show();
                this.mIsDualCameraReady = false;
                return;
            case 2:
                Toast.makeText(this.mActivity, C0049R.string.dual_camera_too_close_toast, 0).show();
                this.mIsDualCameraReady = false;
                return;
            case 3:
