...
public enum CharacterSetECI {
    ...
    static {
        ...
        for (Enum enumR : values()) {
            for (int valueOf : enumR.values) {
                VALUE_TO_ECI.put(Integer.valueOf(valueOf), enumR);
            }
            NAME_TO_ECI.put(enumR.name(), enumR);
            for (Object put : enumR.otherEncodingNames) {
                NAME_TO_ECI.put(put, enumR);
            }
        }
    }
